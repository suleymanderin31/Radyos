	...
	tinyMCE.init({
		...
		template_replace_values : {
			...
			staffid : "test"
                                ...
                                <tbody><tr>
                                  <td><span class="navLink"><a href="yonetim.php?kontrol=djyonet">&gt;&gt; <strong>DJ Yönetimi</strong></a><strong> </strong> &gt;&gt; </span><strong>DJ Düzenle  </strong></td>
                                </tr>
                                <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="680">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td><span class="style8"><strong> &nbsp;</strong></span>Radio Portalınıza görevli djlerinizin bilgilerini düzenleyebilirsiniz. </td>
                                    </tr>
                                  </tbody>
                                </table>
                                <table border="0" cellpadding="0" cellspacing="0" width="680">
							...
							if($ekle){
							echo '<span class="bilgi">DJ Bilgileri yeniden Düzenlenmiştir..</span>';}else{
							echo '<span class="bilgi">DJ bilgilerini düzenlemede hata oluştu.</span>';
							}
						}
							...
							if($ekle){
							echo '<span class="bilgi">DJ Resmi Düzenlenmiştir.</span>';}else{
							echo '<span class="bilgi">DJ resmi düzenlemede hata oluştu.</span>';
							}
							}else{
							echo '<span class="hata">DJ resmi yüklemede hata<br>"djimg" klasörüne yazma yetkisi verdiğinizden emin olunuz.</span>';
							}
							}
							  ...
							  <table border="0" cellpadding="1" cellspacing="1" width="680">
                                ...
                                <tr>
                                  ...
                                  <td class="BeyazGriTD"><form action="yonetim.php?kontrol=djduzenle&id=<?php echo $id; ?>" method="post" ><input name="dosya" type="file" id="dosya" />
                                    <input name="resimdegis" type="submit" id="djekle" value="Değiştir">
                                  Resim seçiniz. 
                              ...
                              <table border="0" cellpadding="1" cellspacing="1" width="680">
                                <tbody><tr>
                                  ...
                                  <td align="center" width="149"><input name="djekle" type="submit" id="uyeekle" value="Düzenle"  /></td>
                                </tr>
                              </tbody></table>
</form>
                              <p>
